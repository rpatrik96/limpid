...
export const ACRONYM_STOPLIST: ReadonlySet<string> = new Set([
  ...
  "ACKNOWLEDGMENTS",
  "ACKNOWLEDGEMENTS",
  // Settled initialisms a reader does not need spelled out. The rule's own
  // rationale exempts "the truly universal: GPU, API, CPU" — so does this list,
  // plus the hardware, format and web initialisms of the same standing. Field
  // jargon stays off it: RL, SGD, CIFAR and BLEU are cliffs and should be flagged.
  "IID",
  "OK",
  "AI",
  "API",
