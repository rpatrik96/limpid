...
> [!TIP]
> **Apply these before flagging a sentence**
>
...
> [!WARNING]
> **Where these rules need judgment, not a regex**
>
...
- [strunk-white.md](strunk-white.md) — the lexical complement (omit needless words, active voice).
