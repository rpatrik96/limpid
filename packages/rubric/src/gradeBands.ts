...
export const gradeBands: GradeBand[] = [
  ...
  { grade: "B", min: 6.5, action: "Good draft — one editing pass; clear the top-3 findings first." },
  { grade: "B-", min: 5.5, action: "Noticeable issues — a focused revision of the weakest sections." },
  { grade: "C+", min: 4.5, action: "Noticeable issues — focused revision; run /writing-diagnosis on flagged paragraphs." },
  { grade: "C", min: 4.0, action: "A reviewer will complain about clarity — significant revision before submission." },
  { grade: "D", min: 3.0, action: "Comprehension barriers — major rewrite of the prose, not just edits." },
  { grade: "F", min: 0.0, action: "Not ready for review — restart the prose with the structural patterns in mind." },
];
