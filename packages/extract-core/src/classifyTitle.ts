/**
 * Map a heading title to a {@link SectionKind}. Format-agnostic: a LaTeX
 * `\section{Introduction}` and a Markdown `# Introduction` classify identically.
 *
...
/** Classify a (already markup-stripped) heading title into a SectionKind. */
